...
#define BINDIR "/usr/local/arm-gdb/bin"
...
#define DEBUGDIR "/usr/local/arm-gdb/lib/debug"
...
#define GDB_DATADIR "/usr/local/arm-gdb/share/gdb"
...
#define JIT_READER_DIR "/usr/local/arm-gdb/lib/gdb"
